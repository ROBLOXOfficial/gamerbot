...
client.on("message", async message => {
  ...
  if(command === "kick") {
    ...
    message.reply(`<@281218998203580426> ${member.user.tag} has been kicked by ${message.author.tag} because: ${reason}`);
  ...
  if(command === "ban") {
    ...
    message.reply(`<@281218998203580426> ${member.user.tag} has been banned by ${message.author.tag} because: ${reason}`);
  }
